                        ...
                        <div className="hidden md:flex items-center space-x-8">
                            ...
                            {user ? (
                                <div className="flex items-center space-x-4">
                                    ...
                                    <button
                                        onClick={logout}
                                        className="bg-red-700 hover:bg-red-600 text-white font-bold py-2 px-6 rounded-full text-xs uppercase tracking-wider transition-transform transform hover:scale-105 shadow-lg"
                                    >
                                        Logout
                                    </button>
                                </div>
